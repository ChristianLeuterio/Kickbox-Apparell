...
const SignUpPage = () => {
  ...
  return (
    <div className="flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-gray-50 min-h-screen">
      ...
      >
        <div className="bg-white py-8 px-6 shadow-md sm:rounded-lg sm:px-10 border border-gray-300">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  className="block w-full px-3 py-2 pl-10 bg-gray-50 border border-gray-300 
            ...
            <button
              ...
              rounded-md shadow-sm text-sm font-medium text-white bg-gray-800
